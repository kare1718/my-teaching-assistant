    ...
    <div className="min-h-screen bg-[#f8f9fa] flex flex-col">
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-6 py-12">
        ...
        <article className="bg-white rounded-xl border border-slate-100 shadow-sm p-8 space-y-8 text-sm leading-7 text-slate-700">
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--primary)] mb-3">1. 개인정보 수집 항목 및 수집 방법</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--primary)] mb-3">2. 개인정보 수집 및 이용 목적</h2>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--primary)] mb-3">3. 개인정보 보유 및 이용 기간</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--primary)] mb-3">4. 개인정보의 제3자 제공</h2>
            <p>회사는 이용자의 개인정보를 원칙적으로 외부에 제공하지 않습니다. 다만 법령의 규정에 의하거나 수사기관의 적법한 요청이 있는 경우는 예외로 합니다.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[var(--primary)] mb-3">5. 개인정보의 처리 위탁</h2>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--primary)] mb-3">6. 정보주체의 권리</h2>
            <p>이용자는 언제든지 개인정보 열람, 정정, 삭제, 처리정지를 요청할 수 있으며, 고객센터를 통해 행사할 수 있습니다.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[var(--primary)] mb-3">7. 개인정보의 안전성 확보 조치</h2>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--primary)] mb-3">8. 개인정보 자동 수집 장치 (쿠키)</h2>
            <p>회사는 로그인 유지 및 서비스 품질 향상을 위해 쿠키를 사용합니다. 이용자는 브라우저 설정을 통해 쿠키 저장을 거부할 수 있으며, 거부 시 일부 서비스 이용이 제한될 수 있습니다.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[var(--primary)] mb-3">9. 개인정보보호책임자</h2>
