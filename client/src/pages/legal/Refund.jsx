  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] flex flex-col">
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-6 py-12">
        <h1 className="text-3xl font-extrabold text-[var(--primary)] tracking-tight mb-2">환불정책</h1>
        ...
        <article className="bg-white rounded-xl border border-slate-100 shadow-sm p-8 space-y-8 text-sm leading-7 text-slate-700">
          <section>
            <h2 className="text-lg font-bold text-[var(--primary)] mb-3">1. 환불 원칙</h2>
            <p>나만의 조교는 이용자가 안심하고 서비스를 이용할 수 있도록 아래와 같이 환불정책을 운영합니다.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[var(--primary)] mb-3">2. 무료 체험</h2>
            <p>Free 플랜은 무료로 제공되며 결제 및 환불이 발생하지 않습니다.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[var(--primary)] mb-3">3. 월간 구독 환불</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--primary)] mb-3">4. 회사 귀책에 의한 환불</h2>
            <p>서비스 장애, 중대한 결함 등 회사의 귀책사유로 서비스를 정상적으로 이용할 수 없었던 경우, 해당 기간에 해당하는 금액을 일할 계산하여 환불하거나 이용 기간을 연장합니다.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[var(--primary)] mb-3">5. 환불 신청 방법</h2>
            <p>환불을 원하는 이용자는 고객센터 이메일 또는 전화로 신청할 수 있으며, 회사는 영업일 기준 3일 이내에 처리합니다.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[var(--primary)] mb-3">6. 환불 제외 사항</h2>
            <ul className="list-disc pl-5 space-y-1">
