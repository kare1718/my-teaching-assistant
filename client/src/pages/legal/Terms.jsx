    ...
    <div className="min-h-screen bg-[#f8f9fa] flex flex-col">
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-6 py-12">
        ...
        <article className="bg-white rounded-xl border border-slate-100 shadow-sm p-8 space-y-8 text-sm leading-7 text-slate-700">
          <section>
            <h2 className="text-lg font-bold text-[#102044] mb-3">제1조 (목적)</h2>
            <p>이 약관은 "나만의 조교"(이하 "회사")가 제공하는 학원 운영 SaaS 서비스(이하 "서비스")의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[#102044] mb-3">제2조 (정의)</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#102044] mb-3">제3조 (약관의 효력 및 변경)</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#102044] mb-3">제4조 (서비스의 제공)</h2>
            <ol className="list-decimal pl-5 space-y-1">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#102044] mb-3">제5조 (유료 서비스 및 결제)</h2>
            <ol className="list-decimal pl-5 space-y-1">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#102044] mb-3">제6조 (이용자의 의무)</h2>
            <p>이용자는 타인의 정보 도용, 서비스 운영 방해, 법령 위반 행위를 하여서는 안 되며, 입력한 학생·보호자 정보에 대해 개인정보보호법을 준수하여야 합니다.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[#102044] mb-3">제7조 (회사의 면책)</h2>
            <p>회사는 천재지변, 불가항력, 이용자의 귀책사유로 인한 서비스 중단·손해에 대하여 책임을 지지 않습니다.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[#102044] mb-3">제8조 (준거법 및 분쟁 해결)</h2>
